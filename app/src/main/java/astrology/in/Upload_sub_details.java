...
public class Upload_sub_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_sub_details);
    ...
    private void uploadFile() {
        ...
        mDatabaseRef.child(uploadId).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(Upload_sub_details.this, "Upload Successsfull",
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Upload_sub_details.this, "Upload not Successsfull",
                        Toast.LENGTH_SHORT).show();
            }
        });
