    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Display_details.this,Upload_details.class);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(size == 0){
                    Toast.makeText(Display_details.this,"No data found",Toast.LENGTH_LONG).show();
        ...
        .setTitle("Delete")
                ...
                .setNegativeButton("Yes", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(Display_details.this, "Item deleted", Toast.LENGTH_SHORT).show();
//                        finish();
